...
public class XmlTests
{
    ...
    internal static class Fix44 {
        internal static string Path = System.IO.Path.Combine(TestContext.CurrentContext.TestDirectory, "Library", "Fixml", "Fix.v4.4.xml");
        internal static System.Xml.XmlDocument Document = Omi.Fixml.Document.From(Path).ToXml();
    }
}
