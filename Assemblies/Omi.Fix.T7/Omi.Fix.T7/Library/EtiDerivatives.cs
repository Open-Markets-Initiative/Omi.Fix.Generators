...
/// <summary>
///  Eurex T7 Eti derivatives xml Library
/// </summary>

public static class EtiDerivatives
{
    /// <summary>
    ///  Gather all Eurex Eti derivatives xmls in library
    /// </summary>
    public static string[] Files()
    {
        var directory = Path.Combine(Directory.GetCurrentDirectory(), "Library", "Eurex.Eti.Derivatives");

        return Directory.GetFiles(directory, "*.xml");
    }

    /// <summary>
    ///  Gather all Eurex Eti derivatives xmls
    /// </summary>
    ...
    /// <summary>
    ///  Sorted list of all Eti derivatives xml files in library
    /// </summary>
    ...
    /// <summary>
    ///  Convert Eti derivatives to normalized Fix models
    /// </summary>
